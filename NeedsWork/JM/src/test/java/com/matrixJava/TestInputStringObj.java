...
public class TestInputStringObj {
	...
	public static void main(String[] args) throws IOException {
		...
		String[] testInput = new String[]{"-c","5x4","12", "32", "43", "44", "5","5","5","4","4",".999999999","0","0","0","9","4","2.71826","3.14159","33","11","0.1136","888","7","6","5"};
		
		
		InputStringObj myTestCase = new InputStringObj("-c", testInput);
