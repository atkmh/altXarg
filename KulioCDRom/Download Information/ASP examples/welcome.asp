...
$Modtime: 10/24/97 12:59p $
$Revision: 74 $
$Workfile: welcome.asp $
-->
...
<META HTTP-EQUIV="Content-Ty<TITLE>PWS Publishing Wizard</TITLE>
<TITLE><%=locPubWiz%></TITLE>
<SCRIPT LANGUAGE="Javascript" SRC="JSBrowser/JSBrowser.js"></SCRIPT>
</HEAD>
<SCRIPT LANGUAGE="Javascript" SRC="JSBrowser/JSBrowser.js"></SCRIPT>
<SCRIPT LANGUAGE="Javascript">
	function callBrowser () {
		 	JSBrowser = new BrowserObj(document.frmFILENAME.FILENAME,POP,TFILE,SMALL);
		 }
</SCRIPT>
...
Sub cmdAdd_Click()
	...
	End If
	If Filepath <> "" Then
		Description=Trim(document.frmDESCRIPTION.DESCRIPTION.value)
		If Description = "" Then
			Description = "   "
		End If
...
%>
		<TD COLSPAN=2>
				<INPUT TYPE=BUTTON VALUE=" <%=locAddBrowsebtn%> " ONClick="VBScript:Browser()" NAME="hdnBrowser">
				</FORM>
			</STRONG></FONT>
    	</TD>
	</TR>
...
Dim insRec, delRec, updRec, operation, newFileDescription, remRecord,  _
neg, negComment, negComment1, negComment2, plurality, nRecords, showNames

'----------Query strings-------------------------

refreshRec=request.querystring("refreshRec")
remRecord = request.querystring("remRecord")
nRecords = request.querystring("nRecords")
...
If refreshRec <> "" Then 'Refresh records
	refreshFiles refreshRec, nRecords
End If
%>
